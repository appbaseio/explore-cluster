			...
			searchbox: {
				...
				featured: {
					design: {
						...
						iconPosition: designAndLayout.iconPosition,
						placeholder: designAndLayout.placeholder,
						focusShortcuts: designAndLayout.focusShortcuts,
						addonBefore: designAndLayout.addonBefore,
						addonAfter: designAndLayout.addonAfter,
						credentials,
					},
