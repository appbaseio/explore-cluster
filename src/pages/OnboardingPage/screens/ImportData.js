...
<pre style="margin: 0; line-height: 180%; border: 0; background: transparent; border-radius: 0;">
 ...
 [
    {
        "adult": false,
        "backdrop_path": "https://image.tmdb.org/t/p/w342/inJjDhCjfhh3RtrJWBmmDqeuSYC.jpg",
        ...
        "popularity": 456.906,
        "poster_path": "https://image.tmdb.org/t/p/w342/pgqgaUx1cJb5oZQQ5v0tNARCeBp.jpg",
    ...
    {
        "adult": false,
        "backdrop_path": "https://image.tmdb.org/t/p/w342/dssCw0mUmD4EriUmkwB3PnsGu4q.jpg",
        ...
        "popularity": 395.824,
        "poster_path": "https://image.tmdb.org/t/p/w342/ablrE8IbWcIrAxMmm4gnPn75AMS.jpg",
...
export default class Introduction extends Component {
	...
	setMapping = () => {
		...
		appbaseHelpers
			...
			.then(() => {
				this.setState({
					status: 'Indexing movies data of 18,000 records... Almost done!',
				});
			})
					...
					<div className="content">
						<header className="vcenter">
							...
							{url ? (
								...
								<p>We will import a dataset of 18,000 movies obtained from TMDB.</p>
							)}
						</header>
